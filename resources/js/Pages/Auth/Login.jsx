            ...
            <div className="min-h-screen bg-background flex">
                ...
                <div className="hidden lg:flex lg:w-1/2 bg-brand-gradient items-center justify-center p-12">
                    <div className="text-center text-white">
                        ...
                        />
                        {/* <h2 className="text-3xl font-bold mb-4">Welcome to TexPort</h2>
                        <p className="text-lg opacity-90">Your trusted platform for modern solutions</p> */}
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                    <div className="max-w-md w-full">
                        ...
                        {status && <div className="mb-4 text-sm text-secondary bg-secondary/10 p-3 rounded-lg">{status}</div>}
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-gray-600">
                                ...
                                <Link href={route('register')} className="text-primary hover:text-primary-600 font-medium">
                                    Sign up for free
                                </Link>
                            </p>
                        </div>
